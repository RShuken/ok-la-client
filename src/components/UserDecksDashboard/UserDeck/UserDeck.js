...
class UserDeck extends Component {
  ...
  handleDeleteDeck = () => {
    console.log('the delete button has been pressed, this is the id of the language deck to be deleted', this.state.language.id )
  ...
  renderUserDeck = () => {
    return (
      <div className="userDeckWrapper">
        ...
        <button onClick={this.handleEditDeck}>edit title</button>
        <div className="languageBox">
          ...
          <h3>
            ...
            <a href={`/language-dashboard/${this.state.language.id}`}>{this.state.language.name}</a>
          </h3>
